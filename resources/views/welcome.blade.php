...
<head>
    ...
    <style>
        body {
            ...
            background-image: url('https://www.20mcc.in/storage/slider/01cc3101-2063-48dd-874f-a5e3006476f21643362836.webp');
...
<body class="antialiased">
    {{-- <div
        ...
        <div id="logo" class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <h2>20 MCC</h2>
            @if (Route::has('login'))
        ...
        <div class="alert alert-success">
            ...
            <h5>Confirmation message has
                been sent to your registered
                mailid and contact number</h5>
        </div>
        @endif
        ...
        {{-- <div>
            <img src="https://www.20mcc.in/storage/slider/01cc3101-2063-48dd-874f-a5e3006476f21643362836.webp"
                alt="img">
        </div> --}}
        {{--
    </div> --}}
